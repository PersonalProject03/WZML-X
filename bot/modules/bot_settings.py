...
DEFAULT_DESP = {
    ...
    "PRIVATE_OUTPUT": "Send completed files and links exclusively to user Bot PM while showing status in group. Default: False.",
    ...
    "SERVICE_BOT_WEBHOOK_URL": "Webhook URL of this bot for receiving push events.",
    "SERVICE_BOT_WEBHOOK_SECRET": "Shared secret key for verifying HMAC-SHA256 signatures of webhooks.",
    "SERVICE_BOT_WEBHOOK_API_KEY": "Optional static API key to verify in X-API-Key header.",
